...
class CynopsisDetails:
    ...
    GET_CYNOPSIS_DETAILS_TEXT_XPATH = (
        By.XPATH, "//*[text()='Individual Cynopsis Details']"
    )
...
class CynopsisResult:
    ...
    GET_USER_NAME_FROM_SCREENING_POPUP_XPATH= (
        By.XPATH, "//input[@id='primaryuser']"
    )
